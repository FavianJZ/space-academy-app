...
const Stage6BugHunt: React.FC<Stage6BugHuntProps> = ({ planetId }) => {
  ...
  const handleComplete = useCallback(() => {
    ...
    // One submission per session with the TOTAL damage dealt - not
    // per-hit (dealBossDamage above is local-only, called on every hit
    // purely for the real-time HP bar/number-popup feedback).

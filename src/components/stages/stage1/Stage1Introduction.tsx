...
const [robotReaction, setRobotReaction] = useState<RobotReaction>('idle');
  ...
  const handleSkipTyping = () => {
    ...
    const fullText = introSteps[currentStep].content;
    setDisplayedText(fullText);
    setIsTyping(false);
    setRobotReaction('idle');
    stopSfx("robotSpeaking", 90);
  ...
  }, [currentStep, introSteps, playSfx, stopSfx]);

  const handleContinue = () => {
    playSfx("dialogueContinue");
      ...
      <div className="stage-content hud-content-layer">
        ...
        >
          ...
          <div className="intro-header">
            ...
            <div className="speaker-badge hud-speaker-badge">AI // {currentIntro.speaker}</div>
          </div>

          <div
            className="intro-body hud-terminal-body"
          ...
          {showContinue && (
            <div className="continue-wrapper hud-sweep-btn-wrapper">
              <button
                className="continue-btn hud-sweep-btn"
                data-audio-cue="none"

...
import { submitStageProgress } from '../../services/progressApi';
            ...
            <div className="flowchart-content hud-content-layer">
                <div className="flowchart-workspace">
                    <div className="flowchart-main">
                        ...
                        >
                            ...
                            <div className="flowchart-diagram">
                                ...
                                <div className="flow-arrow">↓</div>
                                <div
                                    className={`connector-drop-zone ${isDraggingOver ? 'over' : ''} ${tappedConnector && !selectedPath ? 'tap-ready' : ''} ${selectedPath ? (isCorrect ? 'correct' : 'incorrect') : ''
                                        }`}
                    ...
                    <div className="connector-palette">
                        ...
                        <div className="intro-progress flowchart-progress-inline" style={{ marginTop: 'auto', paddingTop: '16px', width: '100%' }}>
                    ...
                    <div className={`feedback-modal ${feedbackStatus}`}>
                        ...
                        <div className="hud-sweep-btn-wrapper" style={{ marginTop: '10px' }}>
                          {feedbackStatus === 'success' ? (
                              ...
                              <button className="retry-btn hud-sweep-btn" onClick={handleRetryChallenge}>TRY AGAIN</button>
                          )}
                        </div>
                    </div>
                )}

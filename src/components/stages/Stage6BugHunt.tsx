...
const Stage6BugHunt: React.FC<Stage6BugHuntProps> = ({ planetId }) => {
            ...
            <div className={`bughunt-intro-card ${isBossMode ? 'boss-intro' : ''}`}>
              ...
              {!isBossMode && (
                <div className="normal-tutorial-section">
                  <div className="boss-coop-label">CONTROLLER TUTORIAL</div>
  ...
  /* ── Shared grid render function (used by both split-screen panels and normal mode) ── */
  ...
  return (
    <div className={`stage-bug-hunt ${isBossMode ? 'boss-mode' : ''} ${screenEffect}`}>
      ...
      {/* ═══════════ BOSS MODE: SPLIT SCREEN LAYOUT ═══════════ */}
      {isBossMode ? (
        <div className="boss-split-screen">
          {/* ── P1 Panel (Left — Mouse) ── */}
          <div className="split-panel split-panel-p1">
            <div className="split-panel-header" style={{ borderColor: COOP_PLAYER_PROFILES.P1.accent }}>
              <div className="split-player-badge" style={{ background: COOP_PLAYER_PROFILES.P1.accent, color: '#000' }}>P1</div>
              <div className="split-player-info">
                <span className="split-player-title" style={{ color: COOP_PLAYER_PROFILES.P1.accent }}>{COOP_PLAYER_PROFILES.P1.title}</span>
                <span className="split-player-hint">{COOP_PLAYER_PROFILES.P1.inputHint}</span>
              </div>
          ...
          {/* ── P2 Panel (Right — Numpad) ── */}
          <div className="split-panel split-panel-p2">
            <div className="split-panel-header" style={{ borderColor: COOP_PLAYER_PROFILES.P2.accent }}>
              <div className="split-player-badge" style={{ background: COOP_PLAYER_PROFILES.P2.accent, color: '#000' }}>P2</div>
              <div className="split-player-info">
                <span className="split-player-title" style={{ color: COOP_PLAYER_PROFILES.P2.accent }}>{COOP_PLAYER_PROFILES.P2.title}</span>
                <span className="split-player-hint">{COOP_PLAYER_PROFILES.P2.inputHint}</span>
              </div>
              <div className="split-player-stats">

...
const SpacemanAnimator: React.FC<{
  ...
  useEffect(() => {
    ...
    if (phase === 0) {
      gsap.to(charRef.current.position, {
        x: 5,
        y: -0.8,
        z: -1.5,
        duration: 0.5,
      ...
      gsap.to(charRef.current.rotation, {
        x: -1,
        y: 0,
        z: 4.8,
        duration: 0.5,
...
const SpeakerSpotlight: React.FC<{ activeSpeaker: ActiveSpeaker }> = ({
  ...
  useFrame(() => {
    if (robotLightRef.current) {
      const targetIntensity = activeSpeaker === "robot" ? 3 : 0;
    ...
    if (spacemanLightRef.current) {
      const targetIntensity = activeSpeaker === "spaceman" ? 3 : 0;
          ...
          <AdaptiveCanvas dpr={[1, 1.25]} quality="auto">
            <Suspense fallback={null}>
              ...
              <SpacemanAnimator
                phase={dialoguePhase}
                charRef={charRef}
                isSpeaking={activeSpeaker === "spaceman"}
              />
              ...
              <RobotAnimator
                ...
                phase={dialoguePhase}
                robotRef={robotRef}
                isSpeaking={activeSpeaker === "robot"}
              />
              ...
              <>
                ...
                <button
                  ...
                  style={{
                    ...
                    right: "120px",
                    padding: "8px 16px",
                    backgroundColor: skipModeActive
                      ? "rgba(0, 255, 255, 0.2)"
                      : "rgba(0, 20, 30, 0.7)",
                    color: "#00ffff",
